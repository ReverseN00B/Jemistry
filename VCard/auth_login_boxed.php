...
<html lang="en">
  <head>
    ...
    />
    <title>Login</title>
    <link rel="icon" type="image/x-icon" href="JavaScript/favicon.ico" />
    ...
    <link href="style/form-2.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <link
      rel="stylesheet"
      type="text/css"
      href="style/theme-checkbox-radio.css"
    />
  ...
  <body class="form">
                ...
                <div class="form">
                  ...
                  <?php
                    if(isset($_SESSION['error'])){
                      ...
                      echo '<span><b><center><p class="text-danger">Incorrect username or password!</p></center></b></span>';
                    }
                  ?>
                  <div class="division">
                    <span>OR</span>
    ...
    <script src="JavaScript/form-2.js"></script>
  </body>
</html>
